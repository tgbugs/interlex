...
CREATE TABLE currently_loading(
       -- this is prior to load events
       -- and rows will be deleted on completion
       -- probably set a trigger to put the stats somewhere
       name uri,  -- fk to names
       id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
